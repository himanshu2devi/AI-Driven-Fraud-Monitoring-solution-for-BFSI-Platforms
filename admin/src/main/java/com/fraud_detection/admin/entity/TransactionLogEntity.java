...
public class TransactionLogEntity {
    ...
    @Column(name="CaseOpened")
    private String CaseOpened;

    public TransactionLogEntity(Long id, String transactionId, String accountFrom, String accountTo, Double amount, String transactionType, String status, String reason, LocalDateTime timestamp,String CaseOpened) {
        this.id = id;
